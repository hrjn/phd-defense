...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \textbf{méthodes bayésiennes et simulation stochastique}.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\textbf{Objectif}: adapter et tester la méthodologie existante avec un \textbf{modèle de dispersion réaliste} en limitant les temps de calcul. 
...
\begin{frame}
	...
	\textbf{Objectif}: valider l'approche avec modèle rétrograde sur un cas simple (milieu rural).
	\begin{columns}
		\column[]{0.5\linewidth}
{\small 		\begin{itemize}
...
\begin{frame}
	...
	\textbf{Objectif}: tester l'approche avec modèle rétrograde sur un cas difficile (urbain avec météo instationnaire)
	\begin{columns}
		\column[]{0.5\linewidth}
		{\small 		\begin{itemize}
...
\begin{frame}
	\frametitle{Cas simulé Opéra}
	\textbf{Problème}: complexité du cas d'étude \\ $\Rightarrow$ {\color{lightred}convergence impossible} avec une configuration normale !
