...
\begin{frame}
	...
	\end{itemize}
	\begin{block}{\textbf{Règle de Bayes}}
...
\begin{frame}
	...
	\begin{block}{\textbf{Méthodes de Monte-Carlo}}
...
\begin{frame}
	...
	\begin{block}{Population Monte Carlo [Cappé et al., 2004]}
	...
	\begin{block}{D-kernel PMC [Douc et al., 2007]}
		\begin{itemize}
...
\begin{frame}
	...
	\begin{block}{M-PMC [Cappé et al., 2008]}
		\begin{itemize}
...
\begin{frame}
	\frametitle{Echantillonnage d'importance adaptatif}
	\begin{block}{Adaptive Multiple Importance Sampling (AMIS) [Cornuet et al., 2012]}
		\begin{itemize}
...
\begin{frame}
	...
	\begin{columns}
		\column{0.7\linewidth}
			\begin{figure}
				\centering
				\includegraphics[width=0.9\textwidth]{fft07_capteurs}
			\end{figure}
		\column{0.4\linewidth}
			\begin{itemize}
				\item {\small Restriction à $N_C = 25$ capteurs}
				\item {\small Plage d'observations par capteur $T_C$ réduite (moyennage)}
			\end{itemize}
	\end{columns}
\end{frame}
%% =====================================================================
